...
<head>
    ...
    <title>成果管理系统 | 获奖成果管理</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- 页面css -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/statics/css/researchAward/index.css">
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet"
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="search-query">
                            ...
                            <div class="form-group">
                                <label>获奖成果名称</label>
                                <input type="text" class="form-control" placeholder="请输入.." id="awardName">
                            </div>

                            <div class="form-group">
                                <label>获奖成果类型</label>
                                <select class="form-control select2" style="width: 100%;" id="awardType">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${researchAwardList}" var="researchAward" begin="0" end="9" step="1">
                                    <tr>
                                        ...
                                        <td>${researchAward.publishDate}</td>
                                        <td>${researchAward.awardWinningName}</td>
                                        <td>${researchAward.awardType}</td>
                                        <td>${researchAward.awardDepartment}</td>
                                        <td>${researchAward.awardDate}</td>
                                        <td>${researchAward.awardNumber}</td>
...
<!-- page script -->
<script src="<%=request.getContextPath()%>/statics/js/researchAward/index.js"></script>
    ...
    $(function() {
        ...
        $("#searchButton").click(function() {
            ...
            searchParams = {
                ...
                "like_research_award.awardName": $("#awardName").val(),
                "between_research_award.createdAt": createdAt,
                "research_award.awardType": awardType
            };
            $.ajax({
                type: "POST",
                url: "admin_search",
