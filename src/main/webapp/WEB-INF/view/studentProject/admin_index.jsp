...
<head>
    ...
    <title>成果管理系统 | 指导学生项目管理</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- 页面css -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/statics/css/studentProject/index.css">
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet"
    ...
    $(function() {
        ...
        $("#searchButton").click(function() {
            ...
            searchParams = {
                ...
                "student_project.projectType": projectType,
                "between_student_project.createdAt": createdAt
            };
            $.ajax({
                type: "POST",
                url: "admin_search",
        ...
        $('#js-export').click(function(){
            ...
            // 页面标识
            querySql += "pageName=student_project_export&";
