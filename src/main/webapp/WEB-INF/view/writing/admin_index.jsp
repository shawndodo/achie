                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="search-query">
                            ...
                            <div class="form-group">
                                <label>著作名称</label>
                                <input type="text" class="form-control" placeholder="请输入.." id="writingName">
                            </div>

                            <div class="form-group">
                                <label>出版号</label>
                                <input type="text" class="form-control" placeholder="请输入.." id="publicationNumber">
                            </div>

                            <div class="form-group">
                                <label>著作类型</label>
                                <select class="form-control select2" style="width: 100%;" id="writingType">
                                    <option selected="selected">全部</option>
                                    <option value="非教材">非教材</option>
    ...
    $(function() {
        ...
        $("#searchButton").click(function() {
            ...
            searchParams = {
                ...
                "between_writing.createdAt": createdAt,
                "writing.writingType": writingType
            };
            $.ajax({
                type: "POST",
                url: "admin_search",
        ...
        $('#js-export').click(function(){
            ...
            // 页面标识
            querySql += "pageName=writing_export&";
