                    ...
                    <div class="box box-primary">
                        ...
                        <form action="edit" method="get" role="form">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label>论文类型</label>
                                    <select class="form-control" name="paperType" id="paperType" disabled="disabled">
                                ...
                                <div class="form-group">
                                    <label>是否独著</label>
                                    <select class="form-control" name="isAlone" id="isAlone" disabled="disabled">
                                ...
                                <div class="form-group">
                                    <label>通讯作者</label>
                                    <select class="form-control" name="messageAuthor" id="messageAuthor" disabled="disabled">
                                        <option value="是" selected="selected">是</option>
                                        <option value="否">否</option>
                                    </select>
                                </div>
