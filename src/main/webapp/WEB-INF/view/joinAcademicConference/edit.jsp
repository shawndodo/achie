                    ...
                    <div class="box box-primary">
                        ...
                        <form action="update" method="post" role="form" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label>是否独著</label>
                                    <select class="form-control select2" style="width: 100%;" id="isInviteReport"
                                            name="isInviteReport" >
                                ...
                                <div>
                                    <input type="hidden" name="id" value="${joinAcademicConference.id}">
                                </div>
                                <div>
                                    <input type="hidden" name="createdAt" value="${joinAcademicConference.createdAt}">
                                </div>
                                <div class="form-group">
