    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/achie/softwareCopyright/index">软件著作权管理</a></li>
                <li class="active">查看软件著作权</li>
            </ol>
        </section>
                    ...
                    <div class="box box-primary">
                        ...
                        <form action="edit" method="get" role="form">
                            <div class="box-body">
                                ...
                                <div>
                                    <input type="hidden" name="softwareCopyrightId" value="${softwareCopyright.id}">
                                </div>
                                <%--<div class="checkbox">--%>
                                <%--<label>--%>
