                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="search-query">
                            ...
                            <div class="form-group">
                                <label>专利名称</label>
                                <input type="text" class="form-control" placeholder="请输入.." id="patentName">
                            </div>

                            <div class="form-group">
                                <label>专利编号</label>
                                <input type="text" class="form-control" placeholder="请输入.." id="patentCode">
                            </div>

                            <div class="form-group">
                                <label>专利类型</label>
                                <select class="form-control select2" style="width: 100%;" id="patentType">
    ...
    $(function() {
        ...
        $("#searchButton").click(function() {
            ...
            searchParams = {
                ...
                "between_patent.createdAt": createdAt,
        ...
        $('#js-export').click(function(){
            ...
            // 页面标识
            querySql += "pageName=patent_export&";
