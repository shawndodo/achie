    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/achie/researchProject/index">科研项目管理</a></li>
                <li class="active">新增科研项目</li>
            </ol>
        </section>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <form action="create" method="post" role="form" enctype="multipart/form-data">
                            <div class="box-body">
                                <%@include file="_research_project_form.jsp" %>
                                
                                <div class="form-group">
                                    <label for="exampleInputFile">上传科研项目</label>
