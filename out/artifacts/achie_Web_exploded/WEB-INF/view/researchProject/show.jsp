    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/achie/researchProject/index">教学论文管理</a></li>
                    ...
                    <div class="box box-primary">
                        ...
                        <form action="edit" method="get" role="form">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label>研究类别</label>
                                    <select class="form-control" name="researchCategory" id="researchCategory" disabled="disabled">
                                ...
                                <div class="form-group">
                                    <label>项目状态</label>
                                    <select class="form-control" name="projectStatus" id="projectStatus" disabled="disabled">
                                ...
                                <div>
                                    <input type="hidden" name="researchProjectId" value="${researchProject.id}">
                                </div>
                                <%--<div class="checkbox">--%>
                                <%--<label>--%>
